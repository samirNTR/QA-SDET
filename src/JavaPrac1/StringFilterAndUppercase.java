...
public class StringFilterAndUppercase {
    ...
    public static void main(String[] args) {
        ...
        // Process the strings and store filtered uppercase strings
         List<String> filteredUpperCaseString = new ArrayList<>();
        for (String str : inputStrings) {
            if (str.startsWith("a"))
            
            {
                filteredUpperCaseString.add(str.substring(0, 1).toLowerCase() + str.substring(1).toUpperCase());
                
               
            }
        }
        
        System.out.println(filteredUpperCaseString);

        // Print the filtered uppercase strings
		/*
		 * for (String result : filteredUpperCaseString) { System.out.println(result);
		 */
        }
  //  }
